...
for (my $base=1; $base <= 19; $base = $base + 2) {
   ...
   # Do stuff with handle.
    ...
    print $fh "a6020Dfoam = OpenFOAMReader(FileName='/scratch/orca/superran/Cable-conference/DES/ReynoldNumberPowerOfFive/IP/60-20D/60-20D.foam') \n";
    ...
    print $fh "plotOnIntersectionCurves1.SliceType.Origin = [0.0, 0.0, $base.0] \n";
    print $fh "plotOnIntersectionCurves1.SliceType.Normal = [0.0, 0.0, 1.0] \n";
    print $fh "# Create a new 'Line Chart View' \n";
    print $fh "# save data \n";
    print $fh "SaveData('/scratch/orca/superran/Cable-conference/DES/ReynoldNumberPowerOfFive/IP/60-20D/pressure/planeNum$base/20DIP60.csv', proxy=plotOnIntersectionCurves1, Precision=5, \n";
