...
for (my $base=1; $base <= 20; $base = $base + 1) {
   ...
   print $fh "# save data \n";
   print $fh "SaveData('E:/GitHub/Cable-conference/DES/ReynoldNumberPowerOfFive/IP/0/timeAvgPressure/line$base/timeAvgPressure.csv', proxy=plotOnIntersectionCurves$base, Precision=5, UseScientificNotation=0, WriteAllTimeSteps=0, FieldAssociation='Points') \n";
}
